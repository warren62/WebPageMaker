...
public class HTMLTagPrototype implements Comparable<HTMLTagPrototype>, Cloneable {
    ...
    /**
     * Constructor that initializes the minimal requirements, meaning the name
     * of the tag and whether it has a closing tag. Note that legal parents and
     * attributes must be subsequently provided in order to setup this object
     * properly.
     *
     * @param initTagName Tag name for this object, like "p" for a paragraph.
     *
     * @param initHasClosingTag Used to initialize this object, true is for HTML
     * elements that have closing tags, false is for those that don't, like
     * "br".
     */
    ...
    /**
     * Accessor method for testing whether or not this tag has a closing tag.
     *
     * @return true if this element has a closing tag, false otherwise, like for
     * "br" and "img".
     */
    ...
    /**
     * Accessor method for getting the node index for this tag in the HTML page
     * tree.
     *
     ...
     *
     * @param initNodeIndex The updated value to use to set this node's index.
     */
    ...
    /**
     * Accessor method for getting the parent index for this tag in the HTML
     * page tree.
     *
     ...
     *
     * @param initParentIndex The updated value to use to set this node's parent
     * index.
     */
     ...
     *
     * @return The value corresponding to the attribute name for this element.
     */
    ...
    /**
     * This method tests to see if the testParent argument is a legal parent tag
     * for this type of tag.
     *
     * @param testParent The name of the parent tag to test to see if this node
     * can be added to such an element.
     *
     * @return true if this node could be added to a testParent element, false
     * otherwise.
     */
    ...
    public boolean isMainParent(String testParent) {
        if (testParent.equals("head") || testParent.equals("link") || testParent.equals("html")
                || testParent.equals("title") || testParent.equals("body")) {
            return true;
        } else {
            return false;
        }
    ...
    /**
     * This method adds the parent argument to the list of legal parent tags for
     * this element.
     *
     * @param parent The name of the element to add to the list of legal parents
     * for this node.
     */
    ...
    /**
     * Accessor method for getting the full set of legal parents for this
     * element.
     *
    ...
    /**
     * This method generates and returns a textual representation of this tag,
     * which we'll only use for displaying tags inside the tree.
     *
...
//            return "<" + tagName + " rel=stylesheet href=./css/home.css type=text/css" + ">";
//        } else {
////            HashMap<String, String> atts = getAttributes();
////            String a = getAttributes().toString();
////            String finAtt = a.substring(1, a.length() - 1);
////	return "<" + tagName + finAtt + ">";
//            String att = "";
//            
//            for (Entry<String, String> entry : attributes.entrySet()) {
//                String value = entry.getValue();
//                att += " " + entry.getKey() + "=" + "\""+value+"\"";
//            }
//            return "<" + tagName + att + ">";
//        }
        return "<" + tagName + ">";
    ...
    /**
     * Used for sorting tags, this method is used for comparing one tag to
     * another for that purpose.
     *
     * @param otherTag The tag to compare to this tag.
     *
     * @return true if the name of this tag is alphabetically before that of the
     * other tag. false otherwise.
     */
    @Override
    ...
    /**
     * This class employs the prototype design pattern in that whenever we wish
     * to add a new tag to our tree, we start by cloning a similar one. This
     * method provides the clone implementation, initializing the object with
     * the same name but empty attributes.
     *
     * @return A newly constructed tag object it the same tag name and
     * attributes, but empty attribute values.
     */
    @Override
